---
layout: default
title: Unsupported	Features, Version 1.1.0
nav_order: 1
---
...
| CONNECTIONPROPERTY | Unsupported: `arg1=net_transport`, `protocol_type`, `auth_scheme`, `local_tcp_port` |
...
| DROP IF EXISTS | Unsupported: `TABLE`, `VIEW`, `PROCEDURE`, `FUNCTION`, `DATABASE`, `INDEX` |
...
| Leading dots in identifier | Fully supported in this version |
...
| Miscellaneous objects | Unsupported: `SEQUENCE`, `LOGIN` |
| NEXT VALUE FOR | Unsupported |
| NONCLUSTERED HASH index | Unsupported |
| NOT FOR REPLICATION | Unsupported |
| NUMERIC/DECIMAL column with non-numeric default | Fully supported in this version |
...
| SERVERPROPERTY | Unsupported: `arg1=Collation`, `CollationID`, `Edition`, `IsSingleUser`, `ServerName`, `Babelfish` |
...
| STRING_AGG() WITHIN GROUP | Unsupported: `arg1=SINGLE ARGUMENT` |
...
| Transition table reference for multi-DML trigger | Fully supported in this version |
| Trigger created with schema name | Fully supported in this version |
