...
| @@variable | Unsupported : `@@CONNECTIONS`, `@@CPU_BUSY`, `@@DBTS`, `@@IDLE`, `@@IO_BUSY`, `@@LANGID`, `@@LANGUAGE`, `@@LOCK_TIMEOUT`, `@@PACKET_ERRORS`, `@@PACK_RECEIVED`, `@@PACK_SENT`, `@@REMSERVER`, `@@SERVICENAME`, `@@TEXTSIZE`, `@@TIMETICKS`, `@@TOTAL_ERRORS`, `@@TOTAL_READ`, `@@TOTAL_WRITE` |  |  |
