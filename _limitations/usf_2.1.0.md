...
| @@variable | Unsupported: `@@VERSION`, `@@SPID`, `@@ROWCOUNT`, `@@TRANCOUNT`, `@@IDENTITY`, `@@ERROR`, `@@FETCH_STATUS`, `@@MAX_PRECISION`, `@@SERVERNAME`, `@@DATEFIRST`, `@@OPTIONS`, `@@MICROSOFTVERSION`, `@@PROCID`, `@@MAX_CONNECTIONS`, `@@NESTLEVEL`, `@@CURSOR_ROWS`, `@@DBTS`, `@@LOCK_TIMEOUT`, `@@SERVICENAME` |
...
| ALTER ROLE | Fully supported in this version |
...
| CREATE ROLE | Fully supported in this version |
...
| GROUP BY ALL | Fully supported in this version |
...
| INFORMATION_SCHEMA | Unsupported: `TABLES`, `COLUMNS`, `DOMAINS`, `TABLE_CONSTRAINTS` |
